...
var drawPlanetPhase = (function(){
    ...
    var defaultConfig = {
        shadowColour: 'white', // CSS background-colour value for the shaded part of the disc
        lightColour:  'black', // CSS background-colour value for the illuminated part of the disc
